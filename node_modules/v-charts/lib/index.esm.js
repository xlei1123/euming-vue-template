...
var wordcloud = function wordcloud(columns, rows, settings, extra) {
  ...
  var tooltip = tooltipVisible && getTooltip$5({ tooltipFormatter: tooltipFormatter });
...
export { VeBar, VeHistogram, VeRing, VeLine, VePie, VeWaterfall, VeFunnel, VeRadar, VeChart, VeMap, VeBmap, VeAmap, VeSankey, VeHeatmap, VeScatter, VeCandle, VeGauge, VeTree, VeLiquidfill, VeWordcloud, install };
